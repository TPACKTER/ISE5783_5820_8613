...
class PointTest {
	...
	//TC01: testing the subtract between two points (simple test)
		...
		//TC11: testing the subtract between 2 Contradictions points-vector
	...
	void testAdd() {
		...
		assertEquals( new Point(1,2,3),p2.add(v1), "the adding does not work correctly");
		   // =============== Boundary Values Tests ==================
		//TC10:testing the adding of a point and vector-while the vector is the same-but negative
	...
	void testDistanceSquared() {
		// =======Equivalence Partitions Tests=======
		// TC01: testing if the Squared distance between two points is correct (simple test)
