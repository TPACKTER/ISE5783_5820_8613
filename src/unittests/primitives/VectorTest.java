...
class VectorTest {
	...
	public void testConstractor() {
		...
		assertThrows(IllegalArgumentException.class, () -> new Vector(0, 0, 0),
				"Constractor() should throw an exception, but it failed");
	}
	...
	void testAddVector() {
		...
		// =============== Boundary Values Tests ==================
		// TC10:Test Zero Vector from adding Two vectors on the same line, opposite
		// directions, equal length
	...
	void testCrossProduct() {
		...
		// =============== Boundary Values Tests ==================
		// TC10:Testing CrossProduct between 2 Vectors with the same Incline
		assertThrows(IllegalArgumentException.class, () -> v4.crossProduct(v6),
				"CrossProduct() should throw an exception, but it failed");
